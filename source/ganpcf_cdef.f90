...
interface
    ...
    function get_shells_c(obj, shells) bind(C, name="get_shells")
        use iso_c_binding
        implicit none
        integer(c_int), value :: get_shells_c
        type(c_ptr), value:: obj
    ...
    function get_num_triangles_c(obj) bind(C, name="get_num_triangles")
        use iso_c_binding
        implicit none
        integer(c_int), value :: get_num_triangles_c
        type(c_ptr), value :: obj
    end function
    ...
    function get_triangles_c(obj, tris) bind(C, name="get_triangles")
        use iso_c_binding
        import :: float3
        integer(c_int), value :: get_triangles_c
        type(c_ptr), value :: obj
    ...
    function set_num_particles_c(obj, numParts) bind(C, name="set_num_particles")
        use iso_c_binding
        implicit none
        integer(c_int), value :: set_num_particles_c
        type(c_ptr), value :: obj
    ...
    function get_2pt_size_c(obj) bind(C, name="get_2pt_size")
        use iso_c_binding
        implicit none
        integer(c_int), value :: get_2pt_size_c
        type(c_ptr), value :: obj
    end function
    ...
    function get_3pt_size_c(obj) bind(C, name="get_3pt_size")
        use iso_c_binding
        implicit none
        integer(c_int), value :: get_3pt_size_c
        type(c_ptr), value :: obj
    end function
    ...
    function calculate_correlations_c(obj, galaxies) bind(C, name="calculate_correlations")
        use iso_c_binding
        import :: float3
        integer(c_int), value :: calculate_correlations_c
        type(c_ptr), value :: obj
